...
import { StyleSheet, View, ScrollView, Text, FlatList, Image, TouchableOpacity, Linking } from 'react-native';
                ...
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    <View style={styles.account}>
                        <View style={styles.avatar}>
                            <MaterialCommunityIcons name="account-circle-outline" size={40} color="#2AB2E2" />
                        </View>
